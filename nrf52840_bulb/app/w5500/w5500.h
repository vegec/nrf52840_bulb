...
/***************----- W5500 GPIO定义 -----***************/
#define W5500_RST_PIN		NRF_GPIO_PIN_MAP(0,17)	//定义W5500的RST引脚
#define W5500_INT_PIN		NRF_GPIO_PIN_MAP(0,19)	//定义W5500的INT引脚


#define  SPI_W5500_MISO_PIN   NRF_GPIO_PIN_MAP(0,20)
#define  SPI_W5500_MOSI_PIN   NRF_GPIO_PIN_MAP(0,21)
#define  SPI_W5500_SS_PIN     NRF_GPIO_PIN_MAP(0,22)
#define  SPI_W5500_SCK_PIN    NRF_GPIO_PIN_MAP(0,23)

#define    SPIW5500_CS_LOW    nrf_gpio_pin_clear(SPI_W5500_SS_PIN)   //片选输出低电平：使能芯片
#define    SPIW5500_CS_HIGH   nrf_gpio_pin_set(SPI_W5500_SS_PIN)     //片选输出高电平：取消片选
...
extern void W5500_GPIO_Init(void);//W5500 GPIO初始化配置
extern void EXTI_PG9_Init(void);//W5500 中断引脚初始化配置
extern void SPI1_Init(void);//W5500 SPI初始化配置(STM32 SPI1)
